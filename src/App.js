        ...
        >
          <Row>
            ...
            <Card style={{ width: "75rem" }}>
                  ...
                  {/* <p>
Carbon Credit Project aims to decrease the effective emission of green-house gases in the atmosphere by charging a price for each ton of emitted carbon and rewarding offsetters who absorb the carbon gases in the atmosphere. The goal of the project is a net zero carbon emission. 
</p>
<p>
Carbon offsetting can be achived through:
    - Forestry & Conservation
    - By the use of renewable energy instead of fossil fuels
    - Community projects and
    - Waste to energy (biogas plants)
    </p>
    <p>
Carbon emission are of 3 types:
    - Direct emission: Carbon emitted by company vehicles or factories
    - Indirect emission: Due to use of electricity purchased externally which are generated by fossil fuels.
    - Indirect emission: Due to shipping, business travel and raw material extraction.
    </p>
...
Carbon footprint is the amount of greenhouse gases generated through regular activities such as driving, flying, usage of electricity etc. One of the issues we faced was measuring the carbon emission and absorption accurately. Thanks to technology, there are plenty of carbon calculators available today. TiCO2 Carbon calculator, developed by National Indian Carbon Coalition (NICC) is an example where we can input the consumption and will return carbon emission. The average annual carbon footprint is 4 metric ton per person globally. 
<br></br><br></br>
Carbon Pricing:
<br></br>
-------------------
<br></br>
Carbon pricing is an economic tool used to push industries, household and government to bring down the emission and invest in cleaner options. Carbon pricing are under control of the government. Carbon pricing can be of two types: 
<br></br>
<br></br>
1. Carbon tax:
<br></br>
    Price that government impose on polluters for each metric ton of CO2 emission generated. 
    <br></br>
    <br></br>
2. Carbon-Trading:
<br></br>
    Market based approach to price carbon emission by putting a cap on or limiting the total amount of carbon based pollutants that can be produced. The government issues carbon credit or a permit, which is a tradable certificate to each company which is a basic trading unit for carbon market. Also, the carbon offset holders can claim carbon credits based on the absorption of GHGs they produce though carbon offseting methods. The government will evaluate the absorption of carbon in their land and will give permit / carbon credit to offset holders which can be traded in the carbon market.
    Here each polluter is alloted a specific quota or allowance of pollution it can emit. Polluters are allowed to trade the permit with each other. for instance, if the Company A has a permit to generate 20 metric ton of CO2 emission, but it only emits 18 metric ton of carbon. Whereas company B emits 22 metric ton of carbon, which has a permit to use 20 metric ton only. So company B can buy this permit of 2 ton from company A at an open market. 
    Price in cap-and-trade schemes are market driven. ie, price of carbon credit vary according to demand and supply. Although the government controls how many units/ credits are alloted to each industry / stakeholders and so how many credits are available for sale on the whole. The price of the carbon credit can vary anywhere from $1 to $137 per metric ton of CO2 emitted. 
    <br></br> */}
